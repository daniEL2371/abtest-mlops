...
def LogisticeRegressionTune(clf, splitted_data, loss_function, folds=5, params = params, run_name = 'LR-Hyperparameter', save=False, save_path=None):
  ...
  mlflow.set_experiment('LogisticRegression-tune')
